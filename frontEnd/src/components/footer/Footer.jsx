    ...
    <div className="p-4 bg-white sm:p-6 dark:bg-gray-900">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a 
                    href="https://www.facebook.com/belarbi.fares21/" 
                ...
                <a 
                    href="https://www.instagram.com/dex_21000/?hl=fr" 
                    className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                >
                ...
                <a 
                    href="https://twitter.com/FaresBelarbi21" 
                    className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                >
                    <svg 
                        className="w-5 h-5" 
                ...
                <a 
                    href="https://dribbble.com/Lord_XeraL" 
                    className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                >
                    <svg 
                        className="w-5 h-5" 
